    ...
    private void assertConfig() {
        if (mParam.gridLayoutManager != null) {
            ...
            if (mParam.adItemInterval % nCol != 0) {
                throw new IllegalArgumentException(String.format("The adItemInterval (%d) is not divisible by number of columns in GridLayoutManager (%d)",
                        mParam.adItemInterval, nCol));
            }
        }
    }
        ...
        if (mParam.forceReloadAdOnBind || !adHolder.loaded) {
            AdLoader adLoader = new AdLoader.Builder(adHolder.getContext(), mParam.admobNativeId)
                    .forNativeAd(NativeAd -> {
                        ...
                        Log.e("admobnative","loaded : "+adHolder.loaded);
                        ...
                        if(mParam.layout == 0){
                            adHolder.admob_ad_loader_layout.setVisibility(View.GONE);
...
//                        }
    ...
    private static class AdViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout adContainer,admob_ad_loader_layout;
        boolean loaded;
        AdViewHolder(View view) {
            ...
            admob_ad_loader_layout=view.findViewById(R.id.admob_ad_loader_layout);
            loaded = false;
