 ...
 * 描述 : 提示性的Dialog
 */
public class EnableDialog extends Dialog {

    private Bitmap.Config BITMAP_CONFIG = Bitmap.Config.ARGB_8888;
    private int DEFAULT_RADIUS = 12;
    ...
    public int DIALOG_TYPE_DEFAULT = DIALOG_TYPE_INFO;
...
//    private OnNegativeListener mOnNegativeListener;
    ...
    private int mDialogType, mIcon;
    private boolean mIsShowAnim;
    private CharSequence mTitle/*, mContent, mOtherContent*/, mBtnText/*, mNoBtnTest*/;
    ...
    public EnableDialog(Context context, int theme) {
    ...
    private void initView() {
        ...
        View contentView = View.inflate(getContext(), R.layout.layout_enabledialog, null);
...
//        resizeDialog();
        ...
        mPositiveBtn = (ImageView) contentView.findViewById(R.id.btnPositive);
...
//            logoIv.setBackgroundResource(getLogoResId(mDialogType));
            logoIv.setBackgroundResource(mIcon);
        }
//        String sourceString = "Picture Keyboard will <b>NEVER</b> collect any personal data like passwords and credit card numbers.";
//        mContentTv.setText(Html.fromHtml(sourceString));
...
//        mPositiveBtn.setText(mBtnText);
        ...
        mPositiveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnPositiveListener != null) {
                    mOnPositiveListener.onClick(EnableDialog.this);
                }
            }
        });
        initAnimListener();
    ...
    private void setTopCorners(View llBtnGroup) {
        int radius = DisplayUtil.dp2px(getContext(), DEFAULT_RADIUS);
        float[] outerRadii = new float[]{radius, radius, radius, radius, 0, 0, 0, 0};
        RoundRectShape roundRectShape = new RoundRectShape(outerRadii, null, null);
        ShapeDrawable shapeDrawable = new ShapeDrawable(roundRectShape);
    ...
    public EnableDialog setAnimationEnable(boolean enable) {
        mIsShowAnim = enable;
        return this;
    }

    public EnableDialog setTitleText(CharSequence title) {
        mTitle = title;
        return this;
    }

    public EnableDialog setTitleText(int resId) {
        return setTitleText(getContext().getString(resId));
    }

    public EnableDialog setContentText(CharSequence content) {
//        mContent = content;
        return this;
    }

    public EnableDialog setOtherContentText(CharSequence content) {
//        mOtherContent = content;
        return this;
    }

    public EnableDialog setIcon(int micon) {
        mIcon = micon;
        return this;
    }

    public EnableDialog setContentText(int resId) {
    ...
    public EnableDialog setDialogType(int type) {
        mDialogType = type;
        return this;
    }
    ...
    public EnableDialog setPositiveListener(CharSequence btnText, OnPositiveListener l) {
        mBtnText = btnText;
        return setPositiveListener(l);
    }

    public EnableDialog setNegativeListener(CharSequence btnText, OnNegativeListener l) {
//        mNoBtnTest = btnText;
        return setNegativeListener(l);
    }

    public EnableDialog setPositiveListener(int stringResId, OnPositiveListener l) {
        return setPositiveListener(getContext().getString(stringResId), l);
    }

    public EnableDialog setPositiveListener(OnPositiveListener l) {
        mOnPositiveListener = l;
        return this;
    }

    public EnableDialog setNegativeListener(OnNegativeListener l) {
//        mOnNegativeListener = l;
        return this;
    }

    public EnableDialog setAnimationIn(AnimationSet animIn) {
        mAnimIn = animIn;
        return this;
    }

    public EnableDialog setAnimationOut(AnimationSet animOut) {
        mAnimOut = animOut;
        initAnimListener();
        return this;
    }
    ...
    public interface OnPositiveListener {
        void onClick(EnableDialog dialog);
    }
