 ...
 */
public class ThemeDialogTemplateView extends FrameLayout {
...
//  private LinearLayout background;
    ...
    public ThemeDialogTemplateView(Context context) {
        super(context);
    }

    public ThemeDialogTemplateView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public ThemeDialogTemplateView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context, attrs);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public ThemeDialogTemplateView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setNativeAd(NativeAd nativeAd) {
        ...
        if (extras != null) {
            for (String key : extras.keySet()) {
                ...
                Log.d("msg", String.format("%s %s (%s)", key,
                        value.toString(), value.getClass().getName()));
            }
        }
        Log.w("msg", "extras ");
//        if (extras.containsKey(FacebookAdapter.KEY_SOCIAL_CONTEXT_ASSET)) {
//            String socialContext = String.valueOf(extras.get(FacebookAdapter.KEY_SOCIAL_CONTEXT_ASSET));
//            Log.w("msg", "socialContext " + socialContext);
//        }
        String store = nativeAd.getStore();
        String advertiser = nativeAd.getAdvertiser();
...
//    nativeAdView.setPriceView(ad_price);
//    nativeAdView.setStoreView(ad_store);
...
//        if (templateType == R.layout.admob_big_native) {
        ...
        try {
            templateType =
                    attributes.getResourceId(
                            R.styleable.TemplateView_gnt_template_type, R.layout.admob_native_small_dialog);
        } finally {
            attributes.recycle();
        }
...
//    secondaryView = (TextView) findViewById(R.id.ad_store);
