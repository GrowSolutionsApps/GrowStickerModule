...
public class PromptDialog extends Dialog {
    ...
    private TextView mTitleTv, mContentTv, mOtherContentTv, mPositiveBtn;
    ...
    private void initView() {
        ...
        mOtherContentTv = (TextView) contentView.findViewById(R.id.tvOtherContent);
...
//        llTop.setBackgroundDrawable(shapeDrawable);
        ...
        mOtherContentTv.setText(mOtherContent);
        mPositiveBtn.setText(mBtnText);
//        mNegativeBtn.setText(mNoBtnTest);
    }
...
//        });
    ...
    public PromptDialog setOtherContentText(CharSequence content) {
        mOtherContent = content;
        return this;
    }

    public PromptDialog setIcon(int micon) {
        mIcon = micon;
        return this;
    }
