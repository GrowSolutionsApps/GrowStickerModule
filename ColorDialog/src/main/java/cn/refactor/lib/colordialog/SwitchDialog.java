...
//    private OnNegativeListener mOnNegativeListener;
    ...
    public SwitchDialog(Context context, int theme) {
    ...
    private void initView() {
        ...
        View contentView = View.inflate(getContext(), R.layout.layout_switchdialog, null);
...
//        String sourceString = "If You Want to Set This Keyboard ,Then You have must Switch This Keyboard.";
...
//        mPositiveBtn.setText(mBtnText);
        ...
        mPositiveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnPositiveListener != null) {
                    mOnPositiveListener.onClick(SwitchDialog.this);
                }
            }
        });
        initAnimListener();
    ...
    public SwitchDialog setAnimationEnable(boolean enable) {
        mIsShowAnim = enable;
        return this;
    }

    public SwitchDialog setTitleText(CharSequence title) {
        mTitle = title;
        return this;
    }

    public SwitchDialog setTitleText(int resId) {
        return setTitleText(getContext().getString(resId));
    }

    public SwitchDialog setContentText(CharSequence content) {
//        mContent = content;
        return this;
    }

    public SwitchDialog setOtherContentText(CharSequence content) {
//        mOtherContent = content;
        return this;
    }

    public SwitchDialog setIcon(int micon) {
        mIcon = micon;
        return this;
    }

    public SwitchDialog setContentText(int resId) {
    ...
    public SwitchDialog setDialogType(int type) {
        mDialogType = type;
        return this;
    }
    ...
    public SwitchDialog setPositiveListener(CharSequence btnText, OnPositiveListener l) {
        mBtnText = btnText;
        return setPositiveListener(l);
    }

    public SwitchDialog setNegativeListener(CharSequence btnText, OnNegativeListener l) {
//        mNoBtnTest = btnText;
        return setNegativeListener(l);
    }

    public SwitchDialog setPositiveListener(int stringResId, OnPositiveListener l) {
        return setPositiveListener(getContext().getString(stringResId), l);
    }

    public SwitchDialog setPositiveListener(OnPositiveListener l) {
        mOnPositiveListener = l;
        return this;
    }

    public SwitchDialog setNegativeListener(OnNegativeListener l) {
//        mOnNegativeListener = l;
        return this;
    }

    public SwitchDialog setAnimationIn(AnimationSet animIn) {
        mAnimIn = animIn;
        return this;
    }

    public SwitchDialog setAnimationOut(AnimationSet animOut) {
        mAnimOut = animOut;
        initAnimListener();
        return this;
    }
    ...
    public interface OnPositiveListener {
        void onClick(SwitchDialog dialog);
    }
